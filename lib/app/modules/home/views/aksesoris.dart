...
Widget Aksesoris(BuildContext context) {
  ...
  return Obx(() {
    ...
    if (controller.modelAksesoris.data == null ||
        controller.modelAksesoris.data!.isEmpty) {
    ...
    return Padding(
      ...
      child: GridView.builder(
        ...
        shrinkWrap: true,
        itemCount: controller.modelAksesoris.data!.length,
        ...
        itemBuilder: (context, index) {
          final terbaruData = controller.modelAksesoris.data![index];
