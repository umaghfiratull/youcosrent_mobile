...
Widget Terlaris(BuildContext context) {
  ...
  return Obx(() {
    ...
    if (controller.modelterlaris.data == null ||
        controller.modelterlaris.data!.isEmpty) {
    ...
    return Padding(
      ...
      child: GridView.builder(
        ...
        shrinkWrap: true,
        itemCount: controller.modelterlaris.data!.length,
        ...
        itemBuilder: (context, index) {
          final terbaruData = controller.modelterlaris.data![index];
