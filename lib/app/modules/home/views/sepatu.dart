...
Widget Sepatu(BuildContext context) {
  ...
  return Obx(() {
    ...
    if (controller.modelsepatu.data == null ||
        controller.modelsepatu.data!.isEmpty) {
      controller.loadSepatu();
      return Center(child: CircularProgressIndicator());
    }
    return Padding(
      ...
      child: GridView.builder(
        ...
        shrinkWrap: true,
        itemCount: controller.modelsepatu.data!.length,
        ...
        itemBuilder: (context, index) {
          final terbaruData = controller.modelsepatu.data![index];
