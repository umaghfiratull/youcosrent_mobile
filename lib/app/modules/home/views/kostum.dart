...
Widget Kostum(BuildContext context) {
  ...
  return Obx(() {
    ...
    if (controller.modelkostum.data == null ||
        controller.modelkostum.data!.isEmpty) {
    ...
    return Padding(
      ...
      child: GridView.builder(
        ...
        shrinkWrap: true,
        itemCount: controller.modelkostum.data!.length,
        ...
        itemBuilder: (context, index) {
          final terbaruData = controller.modelkostum.data![index];
