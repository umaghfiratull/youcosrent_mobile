...
Widget DreamCloset(BuildContext context) {
  ...
  return Obx(() {
    ...
    if (controller.modelDreamcloset.data == null ||
        controller.modelDreamcloset.data!.isEmpty) {
      return Center(child: CircularProgressIndicator());
    }
    return Padding(
      ...
      child: GridView.builder(
        ...
        shrinkWrap: true,
        itemCount: controller.modelDreamcloset.data!.length,
        ...
        itemBuilder: (context, index) {
          final terbaruData = controller.modelDreamcloset.data![index];
